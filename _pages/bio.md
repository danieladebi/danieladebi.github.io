...
<!-- <div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.html path="assets/img/gradphoto.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.html path="assets/img/eagles_jersey_pic.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div> -->
...
<div class="row">
    ...
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/nigeria.png" title="Nigeria" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/eagles_jersey_pic.jpg" title="Me in an Eagles Jersey" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
